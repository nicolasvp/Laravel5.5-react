...
class Table extends Component {
    ...
    sendForm(e){
        ...
        if(e.target.name === 'update'){
            ...
            axios.put('http://localhost/react/public/champion/updateChamp/',{champion: formDataUpdate,'Content-Type': 'multipart/form-data'}).then((response) => {
                console.log('adas');
            }, (err) => {
                console.log(err)
            })
/*
            axios({
              method: 'post',
              url: 'http://localhost/react/public/champion/updateChamp/',
              data: formDataUpdate,
              headers: {'Content-Type': 'multipart/form-data'}
            })
            .then((response) => {
    ...
    handleDestroy(event){
        ...
        swal({
            ...
            closeOnConfirm: false
                ...
                axios.delete('http://localhost/react/public/champion/'+value,value)
                .then((response) => {
    ...
    handleClick(event) {
        ...
        if(name === 'show'){
            axios.get('http://localhost/react/public/champion/'+value)
            .then((response) => {
                this.setState({
        ...
        if(name === 'edit'){  
            axios.get('http://localhost/react/public/champion/'+value+'/edit')
            .then((response) => {
                this.setState({
                    champEdit: response.data,
                    action: 'edit'
